// It gives you names for objects and variables from the standard library
//------------------------------------------------------------------------
...
int main()                  // The main function in which the code is written
{                           // start bracket
    cout<<"Hello, nice to meet you!";   // Displays greeting statement
